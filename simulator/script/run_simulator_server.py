...
sys.path.insert(0, str(REPO_ROOT / "third_party" / "giga-datasets"))
sys.path.insert(0, str(REPO_ROOT / "third_party" / "giga-train"))
sys.path.insert(0, str(REPO_ROOT / "third_party" / "giga-models"))

from iMac.sockets import RobotInferenceClient, RobotInferenceServer
