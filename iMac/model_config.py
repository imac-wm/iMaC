...
HUGGINGFACE_MODEL_CACHE = os.environ.get(
    "CVPR2026_WM_MODEL_CACHE",
    os.path.join(REPO_ROOT, "pretrained_models"),
)
DEFAULT_PROMPT_EMBEDDING_PATH = os.environ.get(
    "CVPR2026_WM_PROMPT_EMBEDDING",
    os.path.join(REPO_ROOT, "asserts", "default_prompt_embeds.pth"),
)
DATA_DIR = os.environ.get(
    "CVPR2026_WM_DATA_DIR",
    os.path.join(REPO_ROOT, "data", "CVPR-2026-WorldModel-Track-Dataset"),
)
OUTPUT_DIR = os.environ.get("CVPR2026_WM_OUTPUT_DIR", os.path.join(REPO_ROOT, "outputs"))
WORLDARENA_DATA_DIR = os.environ.get(
    "WORLDARENA_DATA_DIR",
    os.path.join(REPO_ROOT, "data", "WorldArena"),
)
